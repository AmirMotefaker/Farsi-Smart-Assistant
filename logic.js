const WORD_MAP = { "salam": "سلام", "chetori": "چطوری", "khobi": "خوبی", "darya": "دریا", "man": "من", "be": "به", "madrese": "مدرسه", "miravam": "میروم", "baradar": "برادر", "bazar": "بازار", "va": "و", "az": "از", "to": "تو", "in": "این", "on": "آن", "eshtebah": "اشتباه", "hame": "همه", "baz": "باز", "dorost": "درست", "khrooji": "خروجی", "bayad": "باید", "bashe": "باشه", "hastam": "هستم", "hasti": "هستی", "hast": "هست", "ast": "است", "hastim": "هستیم", "hastid": "هستید", "hastand": "هستند", "alan": "الان", "farsi": "فارسی", "baladam": "بلدم", "mersi": "مرسی", "khodahafez": "خداحافظ", "are": "آره", "na": "نه", "komak": "کمک", "daneshgah": "دانشگاه", "\\vhdl sdsjl": "پرایم سیستم", "\\vs\\,gds": "پرسپولیس", "'] \\c": "گچ پژ", "hldv ljt;v": "امیر متفکر", "hldv ljtlv": "امیر متفکر", "hldn ljt;v": "امیر متفکر" };
...
const FARSI_TO_QWERTY_MAP = { 'ض': 'q', 'ص': 'w', 'ث': 'e', 'ق': 'r', 'ف': 't', 'غ': 'y', 'ع': 'u', 'ه': 'i', 'خ': 'o', 'ح': 'p', 'ج': '[', 'چ': ']', 'ش': 'a', 'س': 's', 'ی': 'd', 'ب': 'f', 'ل': 'g', 'ا': 'h', 'ت': 'j', 'ن': 'k', 'م': 'l', 'ک': ';', 'گ': "'", 'ظ': 'z', 'ط': 'x', 'ز': 'c', 'ر': 'v', 'ذ': 'b', 'د': 'n', 'پ': 'm', 'و': ',', 'ژ': 'C', 'ئ': 'm' };

function smart_farsi_converter(text, customDictionary = {}) {
    const text_lower = text.toLowerCase();
    
    // Priority 1: Dictionaries
    ...
    // Priority 2: Check for keyboard mistakes
    const persianRegex = /[\u0600-\u06FF]/;
    // --- THIS IS THE CRITICAL FIX ---
    // If the text contains Persian characters, we assume it's already correct Farsi.
    // The only exception is if the user is trying to convert it to English, which is a rare case.
    // The popup.js logic will handle this by checking Wikipedia first.
    ...
    // If no specific correction rule matches, return the original text.
    return text;
}