...
For v4.5.0 the expected outputs are:

- `Farsi-Smart-Assistant-v4.5.0-chromium.zip`
- `Farsi-Smart-Assistant-v4.5.0-firefox.zip`
- `SHA256SUMS.txt`
...
Get-FileHash .\release\Farsi-Smart-Assistant-v4.5.0-chromium.zip -Algorithm SHA256
Get-FileHash .\release\Farsi-Smart-Assistant-v4.5.0-firefox.zip -Algorithm SHA256
```
...
After the PR is merged and the exact merge SHA is tagged `v4.5.0`, rebuild from that exact tag and attach all files in `release/` to the GitHub Release.

Example:

```powershell
gh release create v4.5.0 `
  .\release\Farsi-Smart-Assistant-v4.5.0-chromium.zip `
  .\release\Farsi-Smart-Assistant-v4.5.0-firefox.zip `
  .\release\SHA256SUMS.txt `
  .\release\release-manifest.json `
  --repo AmirMotefaker/Farsi-Smart-Assistant `
  --title "Farsi Smart Assistant v4.5.0" `
  --verify-tag `
  --generate-notes
```