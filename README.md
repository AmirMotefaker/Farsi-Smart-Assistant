...
| `hldv ljt;v` | **امیر متفکر** | اشتباه کیبórd (عبارت) |
...
لیست خلاصه‌ای از مهم‌ترین تغییرات در هر نسخه. برای مشاهده جزئیات کامل، به صفحه **[Releases](https://github.com/AmirMotefaker/Farsi-Smart-Assistant/releases)** مراجعه کنید.
