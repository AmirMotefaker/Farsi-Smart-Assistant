...
| `chetori?` | **چطوری؟** | فینگلیش |
| `mashin` | **ماشین** | فینگلیش |
| `google` | **google** | تشخیص کلمه صحیح انگلیسی |
| `fs;jd` | **فسنجان** | اشتباه کیبورد (فارسی به انگلیسی) |
...
- **اصلاح خطای کیبورد (دو طرفه):**
    ...
    - `fs;jd` ➡️ `فسنجان` (که برعکس آن `فسنجان` ➡️ `fs;jd` است)
- **تبدیل فینگلیش:** `chetori?` ➡️ `چطوری؟`
