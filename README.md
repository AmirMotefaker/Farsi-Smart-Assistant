...
</p># 🇮🇷 دستیار هوشمند فارسی (Farsi Smart Assistant)
...
در جدول زیر، ۱۰ مثال واقعی از انواع خطاهای رایج که این افزونه به صورت هوشمند اصلاح می‌کند را مشاهده می‌کنید:

| ورودی اشتباه کاربر | خروجی اصلاح‌شده توسط افزونه | نوع خطا |
| :--- | :--- | :--- |
| `hdvhk` | **ایران** | اشتباه کیبورد (انگلیسی به فارسی) |
| `hldv ljt;v` | **امیر متفکر** | اشتباه کیبورد (عبارت) |
| `\vhdl sdsjl` | **پрайم سیستم** | اشتباه کیبورد (با علائم) |
| `\vs\,gds` | **پرسپولیس** | اشتباه کیبورد (ترکیبی) |
| `salam chetori?` | **سلام چطوری؟** | فینگلیش |
| `slm` | **سلام** | فینگلیش (مخفف) |
| `google` | **گوگل** | فینگلیش (اسامی خاص) |
| `حقهئث` | **prime** | اشتباه کیبورد (فارسی به انگلیسی) |
| `;g,n,` | **کلمن** | اشتباه کیبورد (پیچیده) |
| `jivsd,k` | **تولیدی** | اشتباه کیبورد (رایج) |
...
- **پاپ‌آپ اصلی:** پنل مدیریتی کامل با طراحی مدرن.
...
از هرگونه مشارکت در این پروژه استقبال می‌شود. می‌توانید از طریق بخش [Issues](https://github.com/AmirMotefaker/Farsi-Smart-Assistant/issues) مشکلات را گزارش داده یا ایده‌های جدید مطرح کنید.
