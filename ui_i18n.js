(() => {
    ...
    const catalog = Object.freeze({
        fa: Object.freeze({
            'common.productName': 'دستیار هوشمند فارسی',
            'common.productEnglishName': 'Farsi Smart Assistant',
            'common.themeToLight': 'فعال کردن حالت روشن',
            'common.themeToDark': 'فعال کردن حالت تاریک',
            'common.languageSwitcher': 'زبان رابط کاربری',
            'popup.documentTitle': 'دستیار هوشمند فارسی',
            ...
            'popup.statusSiteExcluded': 'فعال؛ سایت فعلی مستثنا شده است',
            ...
            'popup.githubLabel': 'GitHub پروژه Farsi Smart Assistant',
            ...
            'options.documentTitle': 'تنظیمات دستیار هوشمند فارسی',
            ...
            'sites.documentTitle': 'مدیریت سایت‌ها — دستیار هوشمند فارسی',
        ...
        en: Object.freeze({
            ...
            'popup.statusSiteExcluded': 'Active; current site is excluded',
            ...
            'popup.githubLabel': 'Farsi Smart Assistant project on GitHub',
            ...
            'options.documentTitle': 'Farsi Smart Assistant Settings',
            ...
            'sites.documentTitle': 'Site Management — Farsi Smart Assistant',
